        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-fl">----管理员个人信息--</div>
                    <!--
                    ...
                    <form class="am-form tpl-form-border-form tpl-form-border-br" enctype="multipart/form-data"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <input type="hidden" name="userPermiss"
                                       <c:if test="${requestScope.manager.permission =='超级管理员'}">
                                           value="0"
                                        </c:if>
                                        <c:if test="${requestScope.manager.permission =='普通管理员'}">
                                              value="1"
                                        </c:if>
                                 />
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img" id="user-image" name="userImage">
                                        <img height="100px" height="100px" class="img-dynic" id="img-first"
                                        <c:if test="${!empty requestScope.manager.image}">
                                    ...
                                    <input id="doc-form-file" name="multipartFile" onchange="getImgURL(this)" type="file" >
                                </div>
