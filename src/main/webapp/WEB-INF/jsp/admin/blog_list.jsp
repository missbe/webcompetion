                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                ...
                                <c:if test="${!empty requestScope.blogList}">
                                    <c:forEach var="blog" items="${requestScope.blogList}">
                                        <tr class="gradeX">
                                            <td>
                                                <img src="<%=basePath%>${blog.blogImage}" class="tpl-table-line-img" alt="">
                                            </td>
                                            <td class="am-text-middle">${blog.blogTitle}</td>

                                            <td class="am-text-middle">${requestScope.managerList[blog.adminId]}</td>
                                            <td class="am-text-middle">${blog.blogTime}</td>
                                            <td class="am-text-middle">
                                                <div class="tpl-table-black-operation">
                                                    <a href="javascript:;" value="${blog.id}" class="blog_edit">
                                                        <i  class="am-icon-pencil "  data-toggle="modal" data-target="#myModal"></i> 编辑
                                                    </a>
                                                    <a href="javascript:;" value="${blog.id}" class="tpl-table-black-operation-del doc-confirm-toggle">
...
//            alert($(this).text());
        ...
        $(".blog_edit").click(function () {
            id=$(this).attr("value");
//            alert(id);
            window.location.href="<%=basePath %>admin/blog/edit?id="+id;
        });
        $('.doc-confirm-toggle').on('click', function() {
            $('#my-confirm').modal({
                ...
                onConfirm: function(options) {
                    console.log("ID:"+id);
                    window.location.href="<%=basePath %>admin/blog/delete?id="+id;
                }
            });
        ...
        $("#buttonAdd").click(function () {
            window.location.href="<%=basePath %>admin/blog/report";
        });
    });
