            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form class="am-form tpl-form-border-form tpl-form-border-br" id="myForm" method="post"
                          action="<%=basePath%>admin/gallery/saveImage" enctype="multipart/form-data">
                        <div class="am-form-group">
                            <label for="user-title" class="am-u-sm-3 am-form-label">标题 <span
                                    class="tpl-form-line-small-title">Title</span></label>
                            <div class="am-u-sm-9">
                                <input type="hidden" name="id" value="${requestScope.gallery.id}"/>
                        ...
                        <div class="am-form-group">
                            <label for="user-category" class="am-u-sm-3 am-form-label">添加分类 <span
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea class="" rows="5" id="user-intro" name="content" placeholder="请输入图文介绍"></textarea>
                            </div>
                        </div>


                        <div class="am-form-group">
                            <label for="user-label" class="am-u-sm-3 am-form-label">添加标签 <span
                                    class="tpl-form-line-small-title">TAG</span></label>
                            <div class="am-u-sm-9">
                                <select data-am-selected="{searchBox: 1}" style="display: none;" name="tags"
                                        id="user-label">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file" id="user-image">
                                    <div id="fileroot" class="am-u-sm-9">
                                        <div class="am-u-sm-4 newFile0 " id="newFile0">
                                            <div class="tpl-form-file-img">
                                                <img class="doc-form-file" id="doc-form-file0"
                                            ...
                                            <input class="doc-form-file"
                                                   onchange="getImgURL(this,'doc-form-file0')"
                                                   type="file"  name="upfile0">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function getImgURL(node, imageId) {
        var imgURL = "";
        try {
            var file = null;
    ...
    function createHtml() {
        ...
        var idsCopy = 'doc-form-file' + index;
        var name = 'upfile' + index;
        var newFileId='newFile'+index;

        console.log("idsCopy:" + idsCopy);

        var fileHtml = "<div id='"+newFileId+"' class='am-u-sm-4 newFile'><div class='tpl-form-file-img'>" +
                " <img id='" + idsCopy + "' src='<%=basePath%>static/admin/assets/img/k.jpg' width='200px' height='120px'>" +
                " </div>" +
                "<button type='button' class='am-btn am-btn-danger am-btn-sm addButton' >" +
                "<i class='am-icon-cloud-upload'" + "></i> ==选择图片==</button>" +
                "<input  class='doc-form-file' onchange=\"getImgURL(this,'" + idsCopy + "')\" type='file' name='" + name + "'></div>";

        // $("#fileRoot").prepend(fileHtml);
        $("#fileroot").append(fileHtml);
       // $("#newFile"+(index-1)).after(fileHtml);
    }
    function deleteHtml() {
        $(".newFile").remove();
        index=0;///reset
